...
1. HTML form to collect user data: Name, Student ID, Program, Email, Hobbies, and Short Introduction

2. Servlet (ProfileServlet) for processing submissions and interacting with the database

3. JSP (viewProfiles.jsp) to display all profiles with search, filter, edit and delete functionality
